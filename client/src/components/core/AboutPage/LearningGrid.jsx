...
function LearningGrid() {
  return (
    <div className="mx-auto grid w-11/12 max-w-maxContent justify-items-center py-[5.6rem] text-richBlack-5 md:grid-cols-[repeat(auto-fill,_minmax(270px,_1fr))]">
      {LearningGridArray.map((card, i) => {
        return (
          <div
            key={i}
            className={`${i === 0 && "sm:col-span-2 xl:h-[294px]"}  ${
              card.order % 2 === 1
